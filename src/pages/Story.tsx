...
const timeline = [
  {
    date: "First Meeting",
    location: "Success Education Point",
    description: "The day our eyes met and everything changed. A simple maths class  turned into hours of conversation that felt like minutes.",
    icon: Coffee,
    image: gallery11
  },
  {
    ...
    description: "A perfect evening under the stars. We walked through the mall, sharing stories and dreams as the sun set over the city.",
    icon: MapPin,
    image: img13
  },
  {
    date: "First Kiss",
    location: "Netaji Subhash Palace",
    description: "In that moment, time stood still, when your breath touched mine for the very first time.",
    icon: Music,
    image: img11
  },
];
